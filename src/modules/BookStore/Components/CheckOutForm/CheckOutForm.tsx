    ...
    if (stripeToken && address.complete) {
      ...
      try {
        ...
        navigate("/dashboard/order-confirmation", {
          state: { orderId: newOrderId, totalAmount, data },
        });
      } catch (error) {
      ...
      <Grid container spacing={4} justifyContent={"center"} padding={2}>
        <Grid
          ...
          sx={{
            ...
            padding: "60px",
            background:
              "linear-gradient(82.93deg, #FFE6E6 0%, #F5FFFE 113.52%)",
            boxShadow: "0px 4px 4px 0px #00000040",
          }}
        >
          <Box component="form" onSubmit={handleSubmit}>
            <Typography sx={{ color: "#000000" }}>Card Data</Typography>
            <Box
              sx={{
                backgroundColor: "#ffffff",
                boxShadow: "0 4px 4px 0 #00000020",
                padding: "10px",
                borderRadius: "4px",
                marginBottom: "20px",
              }}
            ...
            <Button
              ...
              color="primary"
              fullWidth
              sx={{ marginTop: 3, backgroundColor: "#ED553B", color: "#fff" }}
            >
              CHECKOUT
            </Button>
            <Button
              ...
              color="primary"
              fullWidth
              sx={{ marginTop: 3, color: "#ED553B", borderColor: "#ED553B" }}
            >
              CONTINUE SHOPPING
            </Button>
          </Box>
